...
//   React.useEffect(() => {
//     var animDuration = 25; // speed sarthak
...
//   return <div className="fixed" ref={lottieRef}></div>;
// };
...
// const SkillsPageSecMobile = () => {
//   const lottieRef = React.useRef<HTMLDivElement>(null);

//   React.useEffect(() => {
//     var animDuration = 125; // speed sarthak
//     const anim = lottie.loadAnimation({
//       container: lottieRef.current!,
//       renderer: "svg",
//       loop: false,
...
// export { SkillsPageSec, SkillsPageSecMobile };
